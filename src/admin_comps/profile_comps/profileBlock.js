...
function ProfileBlock(props) {
    ...
    useEffect(() => {
        let urlUsers = apiUrl + "/blockeds/profile/" + props.match.params.id;
                    ...
                    <div className="row coralbg white">
                        ...
                        <div className="col-md-8 no-pad">
                            <div style={{ cursor: "pointer" }} className="user-image" data-toggle="modal" data-target="#myModal">
                                <img className="img-responsive thumbnail" src={apiUrl+'/images/users_imgs/' + imgArr[0]} alt="omg"/>
...
//                           <img className="img-responsive thumbnail" src={apiUrl+"images/users_imgs/"+profileSingle.image} width="400" />
...
//                               <img className="img-responsive thumbnail" src={apiUrl+"images/users_imgs/"+profileSingle.image} />
...
//                   <div className="row overview" style={{ padding: "30px" }}>
//                       <div>
//                           <div className="details-user-st about-pro-st"><b>My self summery</b></div>
//                           <p className="p-pro-st">{profileSingle.about_me}</p>
//                           <div className="details-user-st about-pro-st"><b>My traits</b></div>
//                           <p className="p-pro-st">{profileSingle.my_traits}</p>
//                           <div className="details-user-st about-pro-st"><b>Hobbies</b></div>
...
//                       <div>
//                           <div className="details-user-st"><i className="fa fa-flash fafa-pro-st"></i><div>{profileSingle.orientation}, {profileSingle.gender}, {profileSingle.relationship}, {profileSingle.relationship_type}</div></div>
//                           <div className="details-user-st"><i className="fa fa-envelope fafa-pro-st"></i><div>{profileSingle.email}</div></div>
//                           <div className="details-user-st"><i className="fa fa-star fafa-pro-st"></i><div>{profileSingle.height}</div></div>
                         
//                           <div className="details-user-st"><i className="fa fa-globe fafa-pro-st"></i>
//                           {(profileSingle.speaks) ? profileSingle.speaks.map((item, i) => <div>{item} ,</div>) : <div>{profileSingle.speaks} </div>}
//                           {profileSingle.education} </div>

//                           <div className="details-user-st"><i className="fa fa-glass fafa-pro-st" ></i><div>Smoking {profileSingle.smoking},  Drinks {profileSingle.drinking}</div></div>
//                           <div className="details-user-st"><i className="fa fa-home fafa-pro-st"></i><div>{profileSingle.children}, {profileSingle.pets}</div></div>
//                           <div className="details-user-st"><i className="fa fa-eye fafa-pro-st"></i><div>Looking for man for long-term-dating</div></div>
//                       </div>
