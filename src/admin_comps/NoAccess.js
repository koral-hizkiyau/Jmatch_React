...
{/* 
        ...
        //     <div className="d-flex justify-content-center text-center" style={{paddingTop: "8rem",paddingBottom:"6rem", color: "red",fontSize:"25px"}}><b>Access Denied!</b></div>
        //     </div>  */}